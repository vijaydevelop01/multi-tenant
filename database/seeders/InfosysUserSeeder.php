...
class InfosysUserSeeder extends Seeder
{
    protected string $tenantDatabase = 'infosys_db';
    ...
    public function run(): void
    {
        ...
        User::on('tenant')->create([
            'name' => 'INFOSYS',
            'email' => 'infosysuser@gmail.com',
            'password' => Hash::make('12345678'),
        ]);

        $this->command->info("InfosysUserSeeder: seeded into [{$this->tenantDatabase}]");
    }
